...
$composerAutoload = getcwd() . '/PayPal-PHP-SDK/autoload.php';
if (!file_exists($composerAutoload)) {
    //If the project is used as its own project, it would use rest-api-sdk-php composer autoloader.
    $composerAutoload = dirname(__DIR__) . '/PayPal-PHP-SDK/autoload.php';
    if (!file_exists($composerAutoload)) {
...
$clientId = 'AXGlZJ-6rLnwBMhHMkuaQSpdbKyBIbcwWiIUJvBeCO7qEvdUI2DiM_b2biBZzydhXski8KUkpF55zCOl';
$clientSecret = 'EDb62EA0yG8VMYBCtN0QMcVZNdBcZWjEXtt-TH3URFskKYQ1gVrUJnx5DE0pl91PTntZ9R8SwuAp3q5l';
